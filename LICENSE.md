...
\[Public Invention\] seeks to build a [free-culture](https://en.wikipedia.org/wiki/Free-culture_movement) public commons of works, including poosibly
...
to promote \[Public Invention\]; for low-effort diagrams we may use [CC0 (public domain)](https://creativecommons.org/publicdomain/zero/1.0/).
...
If \[Public Invention\] is a legal entity (*it is a US 501c3 Nonprofit*), volunteers are expected to assign the copyright of work done on \[the REc project\] to \[Public Invention\] so that in a copyright dispute there is a single copyright holder (\[this organization\]) to simplify things. \[This organization\] will continue to attribute the work to original author where feasible.
